...
COMMENT ON COLUMN clm.referentiel_foncier.env_agricoleext_surf IS 'Surface d’environnement agricole externe';
COMMENT ON COLUMN clm.referentiel_foncier.env_agricoleext_pct IS 'Pourcentage de surface agricole externe';
COMMENT ON COLUMN clm.referentiel_foncier.env_ao_surf IS 'Surface des autres zones environnementales';
COMMENT ON COLUMN clm.referentiel_foncier.env_ao_pct IS 'Pourcentage de surface des autres zones environnementales';
...
COMMENT ON COLUMN clm.referentiel_foncier.env_mt_surf IS 'Surface des milieux terrestres';
COMMENT ON COLUMN clm.referentiel_foncier.env_mt_pct IS 'Pourcentage des milieux terrestres';
...
COMMENT ON COLUMN clm.referentiel_foncier.commune_origine IS 'Commune d’origine';
